 <?php
	$sbj_visitor='Correo electrónico de confirmación de alta al newsletter de ';
	$sbj_owner='Boletín de solicitud de suscripción de ';
	...
	$msg_visitor='<a href="http://'.$sitename.'">'.$sitename.'</a>'."\n".'<br>'.'Hola. , '.$name."\n".'<br>'.'Gracias por suscribirse a nuestro boletín!';		
